...
Сценарий: _0001 экспорт документов продаж
	...
	И я проверяю или создаю для справочника "Items" объекты:
		...
		| 'e1cib/data/Catalog.Items?ref=b762b13668d0905011eb766bf96b2754' | 'False'        | 4      | 'e1cib/data/Catalog.ItemTypes?ref=b762b13668d0905011eb76684b9f6878' | 'e1cib/data/Catalog.Units?ref=b762b13668d0905011eb76684b9f687b' | 'ValueStorage:AQEIAAAAAAAAAO+7v3siVSJ9' | ''                                                                 | '58793'  | ''            | 'Товар со спецификацией'   | ''                 | ''               | ''               |          |          |          |          |         |
	...
	И я проверяю или создаю для справочника "Users" объекты:
		...
		| 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | 'False'        | 2      | 'CI'          | 'd2dd393f-30ff-4f95-bc3a-66cf68310df1' | ''        | 'ru'               | 'True'       | 'e1cib/data/Catalog.UserGroups?ref=b762b13668d0905011eb767f10805e2c' | 'ru'                        | ''                 | 'CI'             | ''                 | ''               | ''               |
